        ...
        <article className="mx-auto max-w-3xl px-4 sm:px-6">
          ...
          <div className="space-y-7 text-[15px] font-light leading-relaxed text-muted md:text-base">
            ...
            <section>
              ...
              <p>We use appropriate security measures to protect user data, including reasonable administrative, technical, and physical safeguards designed to protect information from unauthorized access, use, or disclosure. We review these safeguards periodically. We retain personal information only as long as reasonably necessary for the purposes described in this policy, to meet legal and recordkeeping obligations, and to resolve disputes.</p>
            </section>
