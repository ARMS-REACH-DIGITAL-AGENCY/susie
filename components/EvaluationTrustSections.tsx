...
export default function EvaluationTrustSections() {
  ...
  const returnToForm = () => window.scrollTo({ top: 0, behavior: "smooth" });

  if (!visible) return null;

  return (
    <div className="bg-cream">
      <section id="meet-susie" className="scroll-mt-20 py-12 md:scroll-mt-24 md:py-16">
        <div className="mx-auto grid max-w-5xl items-center gap-8 px-4 sm:px-6 md:grid-cols-[0.78fr_1.22fr] md:gap-12">
          <div className="relative mx-auto h-[360px] w-full max-w-sm overflow-hidden rounded-[22px] bg-white shadow-[0_14px_36px_rgba(60,40,80,0.12)] md:h-[470px]">
            <Image
              ...
              alt="Susie Bute of Susie Sculpts"
              fill
          ...
          <div>
            ...
            <h2 className="font-serif text-4xl font-light leading-[1.05] text-[#2c1f14] md:text-5xl">
              A professional first step without pressure.
            </h2>
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-3">
              <div className="rounded-[16px] border border-purple/15 bg-white/75 p-4 text-center">
                <p className="font-serif text-2xl text-purple">30+</p>
                <p className="mt-1 text-xs font-light text-muted">Years in wellness</p>
              </div>
              <div className="rounded-[16px] border border-purple/15 bg-white/75 p-4 text-center">
                <p className="font-serif text-2xl text-purple">1:1</p>
                <p className="mt-1 text-xs font-light text-muted">Personal guidance</p>
              </div>
              <div className="rounded-[16px] border border-purple/15 bg-white/75 p-4 text-center">
                <p className="font-serif text-2xl text-purple">No</p>
                <p className="mt-1 text-xs font-light text-muted">Pressure or obligation</p>
              </div>
            </div>

            <button type="button" onClick={returnToForm} className="btn-primary mt-6 w-full sm:w-auto">
      ...
      <section id="faq" className="scroll-mt-20 bg-white/55 py-12 md:scroll-mt-24 md:py-16">
        <div className="mx-auto max-w-3xl px-4 sm:px-6">
              ...
              <div key={faq.q} className="overflow-hidden rounded-[16px] border border-stone bg-white/80">
                ...
                {open === index && (
                  <div className="px-5 pb-5">
                    <p className="font-sans text-sm font-light leading-relaxed text-muted">{faq.a}</p>
                  </div>
                )}
              </div>
            ))}
          ...
          <div className="mt-8 rounded-[20px] border border-purple/15 bg-purple/5 p-5 text-center md:p-7">
            ...
            <p className="mx-auto mt-2 max-w-xl text-sm font-light text-muted">
              Share your information, answer five quick questions, and receive your private starting-point recommendation.
            </p>
            <button type="button" onClick={returnToForm} className="btn-primary mt-5">
              Start My Free Evaluation
            </button>
          </div>
        </div>
