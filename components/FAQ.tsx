...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="scroll-mt-[72px] bg-white/50 py-9 md:scroll-mt-[88px] md:py-12">
      <div className="mx-auto max-w-3xl px-4 sm:px-6">
        <div className="mb-6 text-center"><p className="section-label mb-2">Common Questions</p><h2 className="whitespace-nowrap font-serif text-[clamp(1.85rem,8vw,2.5rem)] font-light leading-tight text-[#2c1f14] md:text-5xl">Frequently Asked Questions</h2></div>
        ...
        <div className="mt-7 text-center"><p className="mb-3 text-sm font-light text-muted">Still have questions? Susie is happy to talk.</p><a href="tel:+14804400909" className="btn-primary inline-flex min-h-[56px] items-center justify-center px-6">Call or Text (480) 440-0909</a></div>
      </div>
    </section>
  );
}
