...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="scroll-mt-16 bg-white/50 py-9 md:scroll-mt-20 md:py-12">
      <div className="mx-auto max-w-3xl px-4 sm:px-6">
        ...
        <div className="mt-7 text-center"><p className="mb-3 text-sm font-light text-muted">Still have questions? Susie is happy to talk.</p><a href="tel:+14804400909" className="btn-primary inline-flex min-h-[56px] items-center justify-center px-6">Call or Text Susie</a></div>
      </div>
    </section>
  );
}
