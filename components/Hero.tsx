    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-cream via-stone/40 to-cream pb-8 pt-20 md:pb-16 md:pt-24">
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="md:hidden">
          <p className="mb-4 text-left font-sans text-[13px] font-semibold uppercase tracking-[0.04em] text-gold">
            Serving the East Valley Since 1995
          </p>

          <h1 className="mb-6 text-left font-serif text-[43px] font-light leading-[0.98] text-[#2c1f14] sm:text-5xl">
            Feel puffy, tired, foggy, inflamed, heavy, or stuck?
          </h1>

          <div className="space-y-5 text-left font-sans text-[16px] font-light leading-relaxed text-muted">
          ...
          <div className="mt-6 grid grid-cols-[minmax(0,1.05fr)_minmax(0,1.2fr)] items-start gap-3">
            <div className="overflow-hidden rounded-md border border-purple/10 bg-white/85 shadow-[0_8px_22px_rgba(60,40,80,0.10)]">
              ...
              <div className="px-3 py-2.5 text-left">
                <p className="font-sans text-[13px] font-semibold leading-tight text-[#2c1f14]">Private help from Susie</p>
                <p className="mt-1 font-sans text-[11px] font-light leading-snug text-muted">A personal, professional first step based on what your body needs.</p>
              </div>
            </div>

            <div className="flex min-h-full flex-col">
              <div className="flex flex-col gap-3">
                <a href="#meet-susie" className="btn-primary flex min-h-[72px] items-center justify-center px-3 py-4 text-center">
                  Meet Susie
                </a>
                <a href="#treatments" className="btn-secondary flex min-h-[72px] items-center justify-center px-3 py-4 text-center">
                  View Treatments
                </a>
              </div>
              ...
              <a
                ...
                className="mt-5 block text-center font-sans text-[19px] font-light text-muted transition-colors hover:text-purple"
              >
                (480) 440-0909
              </a>
            </div>
