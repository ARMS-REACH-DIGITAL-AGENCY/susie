        ...
        <div className="grid items-start gap-7 md:grid-cols-[0.76fr_1.24fr] md:gap-12">
          <div className="md:order-1">
            ...
            <div className="mt-4 border border-purple/15 bg-white/75 p-4 shadow-[0_8px_24px_rgba(60,40,80,0.06)] md:p-5">
              ...
              <ul className="space-y-2">{credentials.map((credential) => <li key={credential} className="flex items-start gap-2.5 text-sm font-light leading-snug text-muted"><span className="mt-[-1px] shrink-0 text-purple">✦</span><span>{credential}</span></li>)}</ul>
          ...
          <div className="md:order-2">
            ...
            <div className="space-y-4 text-base font-light leading-relaxed text-muted md:text-[17px]">
              ...
              <p className="text-center font-medium text-[#2c1f14]">The easiest first step is simply a conversation.<br />Free. Private. No Pressure.</p>
            </div>

            <div className="mt-6 flex justify-center">
              <a href={consultationBookingUrl} target="_blank" rel="noopener noreferrer" className="btn-primary flex min-h-[56px] w-full items-center justify-center whitespace-nowrap px-4 text-center text-[11px] tracking-[0.07em] sm:max-w-md sm:text-xs">Book Free Professional Consult</a>
            </div>
          </div>
        </div>
      </div>
