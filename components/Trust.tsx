        ...
        <div id="meet-susie" className="grid scroll-mt-24 items-start gap-7 md:grid-cols-[0.76fr_1.24fr] md:gap-12">
          ...
          <div className="md:order-2">
            ...
            <div className="space-y-4 text-base font-light leading-relaxed text-muted md:text-[17px]">
              ...
              <div className="border-l-2 border-purple bg-purple/5 px-5 py-4"><p className="font-serif text-2xl font-light leading-snug text-[#2c1f14] md:text-3xl">My goal is not to pressure you into a package. It is to help you feel stronger, healthier, more confident, and more like yourself again.</p></div>
