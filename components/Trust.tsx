        ...
        <div className="grid items-start gap-7 md:grid-cols-[0.76fr_1.24fr] md:gap-12">
          <div className="md:order-1">
            ...
            <div className="mt-4 border border-purple/15 bg-white/75 p-4 shadow-[0_8px_24px_rgba(60,40,80,0.06)] md:p-5">
              ...
              <ul className="space-y-2">{credentials.map((credential) => <li key={credential} className="flex items-start gap-2.5 text-sm font-light leading-snug text-muted"><span className="shrink-0 text-purple">✦</span><span>{credential}</span></li>)}</ul>
